...
inline void *lua_realloc(void *ptr, size_t size) {
  return _lua_realloc(ptr, size);
}
inline void lua_free(void *ptr) { _lua_free(ptr); }
inline void *lua_allocate(size_t size) { return _lua_allocate(size); }
inline void *lua_aligned_allocate(size_t align, size_t size) {
...
inline void lua_free(void *ptr) { mi_free(ptr); }
inline void *lua_allocate(size_t size) { return mi_malloc(size); }
inline void *lua_aligned_allocate(size_t align, size_t size) {
